...
class VTNetEncoder(nn.Module):
    def __init__(self, args):
        super(VTNetEncoder, self).__init__()
...
class BaseModel(torch.nn.Module):
    def __init__(self, args):
        ...
        self.encoder = VTNetEncoder(args)
    ...
    def forward(self, model_input, model_options):
        ...
        x, image_embedding = self.encoder.embedding(state, detection_inputs, action_probs)
