...
def parse_arguments():
    ...
    parser.add_argument(
        '--data-dir',
        type=str,
        default='/home/wangshuo/Data/AI2Thor_offline_data_2.0.2/',
    ...
    # ==================================================
    # arguments related with train_mode
    parser.add_argument(
        '--train-mode',
        type=str,
        default='search',
        help='search, adjustment, high_pretrain or fine_tune three choices'
    )
