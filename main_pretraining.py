...
def main():
    ...
    if args.csiro_bracewell:
        args.data_dir = '/scratch1/du014/Data/AI2Thor_VisTrans_Pretrain_Data/'
    else:
        args.data_dir = os.path.expanduser('/home/wangshuo/Data/AI2Thor_VisTrans_Pretrain_Data/')
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if (epoch + 1) % args.lr_drop == 0 or (epoch + 1) % args.epoch_save == 0:
            ...
            checkpoint_paths.append(os.path.join(save_model_dir, f'avoid_checkpoint{epoch:04}.pth'))
